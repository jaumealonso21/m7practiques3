  ...
  //errores
   ...
   // Mostrar errores encontrados
      ...
      // Mostrar datos introducidos
         ...
         print ("<P>[ <A HREF='formularioVivienda.php'>Insertar otra vivienda</A> ]</P>\n");
      }
...
?>
 ...
 <form method="post" name="formulario" action="formularioVivienda.php" enctype="multipart/form-data">
     <table>
